...
- [[Quick Start]] — five-step tour of ztl's core commands
...
- [[architecture/Cache]] — two-tier invalidation, `.ztl/` schemas
...
- [[Xanadu Lineage]] — Ted Nelson's transclusion vision and ztl view
...
; Run: ztl reason explain "vault-ready-to-publish" --format natural
