...
The scanner is ztl's entry point for understanding a vault. It walks every Markdown file and standalone `.spl` file, extracting [[concepts/Wikilinks]] and [[concepts/Spindle Lisp]] blocks in a single pass.
