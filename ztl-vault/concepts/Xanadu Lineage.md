...
## How ztl implements it

ztl's [[View Command]] is a terminal-native interpretation of Xanadu transclusion:
...
ztl's context cards are read-only excerpts, not full transclusion in the Xanadu sense. The `![[embed]]` wikilink syntax requests content embedding, but ztl's view renders a context card rather than inlining the full page.

## Design decisions

See [[Xanadu View Design]] for the architectural choices behind ztl's implementation, and [[SPEC-009 Xanadu View]] for the full specification.
