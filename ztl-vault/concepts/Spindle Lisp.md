...
Spindle Lisp (SPL) is a domain-specific language for expressing [[concepts/Defeasible Reasoning]] theories. ztl extracts SPL from fenced code blocks in Markdown and from standalone `.spl` files.
