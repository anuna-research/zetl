...
from ztl_ast import AST_VERSION, Wikilink, dispatch, on_node, run, run_one_shot
...
class TestRunLoop(unittest.TestCase):
    def test_handshake_is_first_line(self) -> None:
        ...
        self.assertEqual(responses[0]["ztl_ast"], 1)
    ...
    def test_init_populates_ctx_env(self) -> None:
        ...
        self.assertEqual(env.ztl_version, "1.2.3")
