"""
Dispatch contract tests for ``ztl_ast.dispatch`` (SPEC-032 REQ-3218).

Mirrors ``tools/ztl-ast-js/test/dispatch.test.ts`` so the two helper
...
from ztl_ast.dispatch import DispatchTable
...
class TestOnNode(unittest.TestCase):
    ...
    def test_decorator_exposes_metadata(self) -> None:
        ...
        node_type, original = handle_quote.__ztl_dispatch__  # type: ignore[attr-defined]
