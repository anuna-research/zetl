"""
Protocol-layer tests for ``ztl_ast.protocol`` (SPEC-032 CON-3201 / REQ-3215).
...
class TestHandshake(unittest.TestCase):
    def test_emits_ztl_ast_and_ready(self) -> None:
        line = handshake_line("my-hook", "1.2.3")
        self.assertTrue(line.endswith("\n"))
        payload = json.loads(line)
        self.assertEqual(payload["ztl_ast"], AST_MAJOR)
