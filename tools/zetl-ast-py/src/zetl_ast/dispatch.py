...
Example::
    ...
    from zetl_ast import dispatch, on_node, Wikilink, BlockQuote
...
def on_node(node_type: str) -> Callable[[NodeHandler], NodeHandler]:
    ...
    Used as a decorator, it attaches a ``__zetl_dispatch__`` tuple to
    ...
    The decorator is intentionally thin — ``register.__zetl_dispatch__``
    ...
    def decorator(handler: NodeHandler) -> NodeHandler:
        ...
        register.__zetl_dispatch__ = (node_type, handler)  # type: ignore[attr-defined]
