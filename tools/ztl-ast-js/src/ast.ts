// Typed mirror of tools/ztl-ast-schema-v1.json (v1.0).
//
...
/** Exact two-component schema version emitted by ztl at `Document.ast_version`. */
    ...
    if (major !== AST_MAJOR) {
        throw new SchemaError(
            `ast_version major ${major} does not match this helper's pinned major ${AST_MAJOR}. ` +
                `Upgrade ztl-ast-js, or use the version of the helper pinned to major ${major}.`,
            "$.ast_version",
        );
    }
