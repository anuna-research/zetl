...
zetl builds a directed graph where nodes are pages and edges are [[Wikilinks]]. The graphs powers all link-based queries: forward links, backlinks, multi-hop traversal, shortest path, and orphan detection.
